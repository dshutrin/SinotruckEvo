    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clear_password', models.CharField(blank=True, default=None, max_length=255, null=True, verbose_name='Пароль')),
                ('name', models.CharField(default=None, max_length=150, null=True, verbose_name='ФИО/Название организации')),
                ('phone', models.CharField(blank=True, default=None, max_length=12, null=True, unique=True, verbose_name='Номер телефона')),
                ('manager_task', models.CharField(blank=True, default=None, max_length=150, null=True, verbose_name='Задача менеджера')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_sharing_delete_document_permission', models.BooleanField(default=False, verbose_name='Возможность удалять файлы в файлообменнике')),
                ...
                ('price_list_create_list_permission', models.BooleanField(default=False, verbose_name='Возможность создавать прайс-листы')),
                ('price_list_delete_list_permission', models.BooleanField(default=False, verbose_name='Возможность удалять прайс-листы')),
                ...
                ('contacts_view_permission', models.BooleanField(default=False, verbose_name='Возможность просматривать контакты пользователей (Влияет на доступ к меню)')),
                ('contacts_can_create_user_permission', models.BooleanField(default=False, verbose_name='Возможность создавать пользователей')),
                ('activity_view_permission', models.ManyToManyField(blank=True, related_name='Role_activity_view_permission', to='support.role', verbose_name='Чью активность разрешено просматривать (Влияет на доступ к меню)')),
                ('contacts_can_admin_view_permission', models.ManyToManyField(blank=True, related_name='Role_contacts_can_admin_view_permission', to='support.role', verbose_name='Чьи логины и пароли может видеть')),
                ('contacts_can_edit_permission', models.ManyToManyField(blank=True, related_name='Role_contacts_can_edit_permission', to='support.role', verbose_name='Чьи аккаунты может редактировать')),
                ('contacts_can_view_permission', models.ManyToManyField(blank=True, related_name='Role_contacts_can_view_permission', to='support.role', verbose_name='Чьи контакты может просматривать')),
            ],
            options={
                'verbose_name': 'Роль',
